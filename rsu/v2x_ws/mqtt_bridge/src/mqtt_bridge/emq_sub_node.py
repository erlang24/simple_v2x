...
class SerialPortMgr(Node):
    ...
    def __init__(self,node_name):
        ...
        self.emq_sub = EmqSub(
                ...
                passwd = self._passwd,
              callback = self.sub_thread_call_back)
    ...
    def sub_thread_call_back(self,msg):
        try:
            ros_data = UInt8MultiArray()
            ros_data.data = list(msg)
            self.spat_pub.publish(ros_data)
        except Exception as e:
            print(e)
